...
export function SaharaMapShowcase({
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.86fr_1.14fr] lg:items-stretch">
      <article
        data-premium-card
        className="relative overflow-hidden border border-white/12 bg-[#274d70] p-6 shadow-[0_28px_80px_rgba(17,36,54,0.28)] sm:p-8"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(255,143,43,0.24),transparent_24%),radial-gradient(circle_at_78%_82%,rgba(90,205,255,0.2),transparent_26%),linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]" />
        <div className="relative">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#ffb062]">
            {eyebrow}
          </p>
        ...
        <div className="relative mt-8">
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-[1.75rem] border border-white/12 bg-[linear-gradient(180deg,#1f415f_0%,#35648d_68%,#476f96_100%)]">
            <svg
              aria-hidden="true"
            ...
            >
              <path
                ...
                strokeWidth="2"
              />
              <path d={saharaPath} fill="rgba(255,143,43,0.18)" />
              <path
                d={saharaPath}
                fill="none"
                stroke="rgba(255,176,98,0.65)"
                strokeDasharray="8 8"
                strokeWidth="1.5"
              />
            </svg>
                ...
                >
                  ...
                  <span
                    className={`pointer-events-none absolute left-[calc(100%+0.8rem)] top-1/2 hidden -translate-y-1/2 whitespace-nowrap rounded-full border px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.12em] shadow-[0_12px_32px_rgba(10,22,35,0.24)] transition duration-300 sm:inline-flex ${
                      active
                        ? "border-[#ff8f2b]/45 bg-[#17334d] text-white"
                        : "border-white/12 bg-[#17334d]/82 text-white/70"
                    }`}
                  >
                    {location.name}
                  </span>
            ...
            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-4 rounded-full border border-white/12 bg-[#17334d]/58 px-4 py-3 backdrop-blur-md">
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-white/72">
                {hint}
              </p>
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#ffb062]">
                {activeLocation.stat}
              </p>
            </div>
          </div>
      ...
      <div className="grid gap-4">
        <article
          data-premium-card
          className="overflow-hidden border border-black/10 bg-white shadow-[0_28px_80px_rgba(23,51,77,0.14)]"
        >
          <div className="relative aspect-[16/10] overflow-hidden">
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#ffb062]">
                {activeLocation.stat}
              </p>
            ...
            return (
              <button
                ...
                className={`group overflow-hidden border text-left transition duration-300 ${
                  active
                    ? "border-[#ff8f2b]/45 bg-[#17334d]"
                    : "border-black/10 bg-white hover:border-[#557da5]/34"
                }`}
                data-premium-card
                data-cursor-label={location.name}
                data-magnetic
              >
                <div className="relative aspect-[5/3] overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent_0%,rgba(23,51,77,0.08)_45%,rgba(23,51,77,0.74)_100%)]" />
                </div>
                <div className="p-4">
                  <div className="flex items-center justify-between gap-3">
                    <h4
                      className={`text-base font-semibold ${
                        active ? "text-white" : "text-[#17334d]"
                      }`}
                    >
                      {location.name}
                    </h4>
                    <span
                      className={`text-[0.65rem] font-semibold uppercase tracking-[0.12em] ${
                        active ? "text-[#ffb062]" : "text-[#557da5]"
                      }`}
                    >
                      {location.stat}
                    </span>
